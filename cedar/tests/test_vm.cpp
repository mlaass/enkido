...
// =============================================================================
// PRD prd-runtime-event-transforms Phase 4 Commit C: legacy iter() /
// iterBack() SequenceState rotation tests removed; coverage lives in
// cedar/tests/test_event_reorder.cpp [event-reorder] and
// akkado/tests/test_reorder.cpp [reorder][phase4][iter].
// =============================================================================
