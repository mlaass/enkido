...
// Maps osc() string type names to Cedar oscillator opcodes
    ...
    switch (n.type) {
        ...
        case NodeType::Call: {
            ...
            static const std::unordered_map<std::string_view, Handler> special_handlers = {
                {"osc",     &CodeGenerator::handle_osc_call},
...
// Handles osc(type, freq) and osc(type, freq, pwm) - type resolved at compile time
