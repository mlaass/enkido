...
inline constexpr auto BUILTIN_FUNCTIONS = frozen::make_unordered_map<frozen::string, BuiltinInfo>({
    ...
    {"slow",    {.opcode = cedar::Opcode::NOP,
                 ...
                 .kind = BuiltinKind::PatternTransform}},
    ...
    {"rev",     {.opcode = cedar::Opcode::NOP,
                 ...
                 .kind = BuiltinKind::PatternTransform}},
    {"transport", {.opcode = cedar::Opcode::SEQPAT_TRANSPORT,
                 .input_count = 2,
                 .optional_count = 2,
                 .requires_state = true,
                 .param_names = {"pattern", "trig", "step", "reset", "", ""},
                 .defaults = {1.0f, NAN, NAN, NAN, NAN},
                 .description = "Trigger-driven pattern transport — decouples a pattern from "
                 "the global clock; each trigger edge advances playback.",
                 .extended_param_count = 0,
                 .param_types = {ParamValueType::Pattern},
                 .kind = BuiltinKind::PatternTransform}},
