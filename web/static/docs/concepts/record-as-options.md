...
- [Records reference](../reference/language/records.md) — record literals, field access, destructuring, and state cells.
- [State cells](../reference/builtins/state.md) — record-valued state cells with `cell.field` sugar.
